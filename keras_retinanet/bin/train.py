...
def create_callbacks(model, training_model, prediction_model, validation_generator, args):
    ...
    if args.evaluation and validation_generator:
        if args.dataset_type == 'coco':
            ...
            evaluation = Evaluate(validation_generator, iou_threshold=args.iou_threshold, score_threshold=args.score_threshold, tensorboard=tensorboard_callback, weighted_average=args.weighted_average)
...
def create_generators(args, preprocess_image):
    ...
    if args.random_transform:
        ...
        #transform_generator = random_transform_generator(flip_x_chance=0.5) #commented by me
        transform_generator = random_transform_generator(flip_x_chance=0.0)  #added by me
...
def parse_args(args):
    ...
    parser.add_argument('--max-detections', help='The maximum number of detections to use per image.', dest='max_detections', type=int, default=100)
