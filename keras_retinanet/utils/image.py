...
def preprocess_image(x, mode='caffe'):
    ...
    Args
        ...
        mode: One of "caffe" or "tf".
            ...
            - acfr: will zero-center each color channel with 
                respect to the acfr dataset, without scaling.
            - zcs: will scale piexls between -1 and 1.
...
def adjust_bgr_order(image):
    """ Adjust color channel order of an image.
    Args
        image: Image to adjust.
    """
